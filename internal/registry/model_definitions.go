...
// GetKiroModels returns the standard Kiro (AWS CodeWhisperer) model definitions
	...
	return []*ModelInfo{
		{
			...
			Description:         "Claude 4.5 Opus via Kiro/AWS CodeWhisperer",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			OwnedBy:             "kiro",
			Type:                "kiro",
			DisplayName:         "Claude 4.5 Opus 20251101 (Kiro)",
			Description:         "Claude 4.5 Opus via Kiro/AWS CodeWhisperer",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Description:         "Claude 4.5 Haiku via Kiro/AWS CodeWhisperer",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Description:         "Claude 4.5 Sonnet via Kiro/AWS CodeWhisperer",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			OwnedBy:             "kiro",
			Type:                "kiro",
			DisplayName:         "Claude 4.5 Sonnet 20250929 (Kiro)",
			Description:         "Claude 4.5 Sonnet via Kiro/AWS CodeWhisperer",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Description:         "Claude 4 Sonnet via Kiro/AWS CodeWhisperer",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Description:         "Claude 3.7 Sonnet via Kiro/AWS CodeWhisperer",
			ContextLength:       128000,
			MaxCompletionTokens: 8192,
		},
	}
